import { C as CSS, p as plt, w as win, a as promiseResolve, b as bootstrapLazy } from './index-31b83128.js';
...
const patchEsm = () => {
    ...
    if ( !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-3f434585.js').then(() => {
