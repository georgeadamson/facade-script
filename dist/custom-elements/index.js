...
const PengScript$1 = /*@__PURE__*/proxyCustomElement(PengScript, [1,"peng-script",{"srcProd":[1,"src"],"isIframe":[4,"iframe"],"isOnce":[4,"once"],"isGlobal":[4,"global"],"trigger":[1],"wait":[2],"props":[1],"showWhen":[1,"show-when"],"timeout":[2],"isReady":[16],"errorMessage":[513,"error"],"statusMessage":[513,"status"],"status":[32],"error":[32]}]);
...
export { PengScript$1 as PengScript, defineCustomElements };
